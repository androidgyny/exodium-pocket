...
pub use setup::{
    ...
    init_download_manager, init_log_dir, init_resource_dir, scan_installed_games,
    setup_from_local, setup_import, setup_start, validate_exodos_dir, CollectionDef,
    COLLECTION_MAP, TorrentState,
};
